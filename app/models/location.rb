class Location < ActiveRecord::Base
  ...
  has_many :outgoing_adjacent_locations, :through => :location_edges_out, :source => :location2
  has_many :location_edges_in, :foreign_key => :location2, :class_name => "LocationGraphEdge"
  has_many :incoming_adjacent_locations, :through => :location_edges_in, :source => :location1
